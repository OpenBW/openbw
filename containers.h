...
using a_map = std::map<key_T, value_T, pred_T, alloc<std::pair<key_T, value_T>>>;
template<typename key_T, typename value_T, typename pred_T = std::less<key_T>>
using a_multimap = std::multimap<key_T, value_T, pred_T, alloc<std::pair<key_T, value_T>>>;
...
using a_unordered_map = std::unordered_map<key_T, value_T, hash_t, equal_to_t, alloc<std::pair<key_T, value_T>>>;
template<typename key_T, typename value_T, typename hash_t = std::hash<key_T>, typename equal_to_t = std::equal_to<key_T>>
using a_unordered_multimap = std::unordered_multimap<key_T, value_T, hash_t, equal_to_t, alloc<std::pair<key_T, value_T>>>;
